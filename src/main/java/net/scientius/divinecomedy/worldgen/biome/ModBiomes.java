...
public class ModBiomes {
    ...
    public static final ResourceKey<Biome> WHIRLING_WASTELANDS = registerBiomeKey("whirling_wastelands");
    ...
    public static final ResourceKey<Biome> DEPTHS_OF_DIS = registerBiomeKey("depths_of_dis");
    public static final ResourceKey<Biome> WOOD_OF_SUICIDES = registerBiomeKey("wood_of_suicides");
    public static final ResourceKey<Biome> MALEBOLGE = registerBiomeKey("malebolge");
    ...
    public static void bootstrap(BootstrapContext<Biome> context) {
        ...
        register(context, WHIRLING_WASTELANDS, ModInfernoBiomes.whirlingWastelands(placedFeatures, carver));
        ...
        register(context, DEPTHS_OF_DIS, ModInfernoBiomes.depthsOfDis(placedFeatures, carver));
        register(context, WOOD_OF_SUICIDES, ModInfernoBiomes.woodOfSuicides(placedFeatures, carver));
        register(context, MALEBOLGE, ModInfernoBiomes.malebolge(placedFeatures, carver));
